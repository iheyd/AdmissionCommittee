...
{
    public partial class Rating2UserControl : UserControl
    {
        public Rating2UserControl()
        {
            InitializeComponent();
            dataGridViewRating2.CellClick += DataGridView_CellClick;
            dataGridViewRating2.RowHeadersVisible = false;
            dataGridViewRating2.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dataGridViewRating2.CellFormatting += DataGridView_CellFormatting;
            LoadRatingData2();
        }
        ...
        public void LoadRatingData2()
        {
            ...
            using (var conn = new NpgsqlConnection(connString))
            {
                try
                {
                    ...
                    {
                        cmd.Parameters.AddWithValue("directionId", 2);
                        ...
                        using (var reader = cmd.ExecuteReader())
                        {
                            ...
                            dataGridViewRating2.DataSource = displayTable;

                            if (dataGridViewRating2.Columns.Contains("Базовый ID"))
                                dataGridViewRating2.Columns["Базовый ID"].Visible = false;
                        }
                    }
                }
                catch (Exception ex)
